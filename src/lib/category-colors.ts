...
> = {
  ...
  horloges: {
    active: "bg-accent-cyan text-white shadow-lg shadow-accent-cyan/30",
    idle: "hover:text-accent-cyan",
  },
  petten: {
    active: "bg-accent-coral text-white shadow-lg shadow-accent-coral/30",
